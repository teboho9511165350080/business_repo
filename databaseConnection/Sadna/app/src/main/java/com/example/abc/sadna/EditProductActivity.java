...
public class EditProductActivity extends Activity {
    ...
    // single product url
    private static final String url_patient_detials = "http://vishalthakkar.netai.net/androidphp/get_patient_details.php";

    // url to update product
    private static final String url_update_patient = "http://vishalthakkar.netai.net/androidphp/update_product.php";

    // url to delete product
    private static final String url_delete_patient = "http://vishalthakkar.netai.net/androidphp/delete_patient.php";
    ...
    private static final String TAG_GENDER = "patient_gender";
    private static final String TAG_EMAIL = "patient_email";
    private static final String TAG_ADDRESS="patient_address";
                    ...
                    try {
                        ...
                        if (success == 1) {
                            ...
                            JSONArray productObj = json
                                    .getJSONArray(TAG_PATIENTS); // JSON Array
                            ...
                            txtGender.setText(product.getString(TAG_GENDER));
