...
public class CustomAdapterDisplayDebitorsList extends RecyclerView.Adapter<CustomAdapterDisplayDebitorsList.MyViewHolder> implements Filterable {
    ...
    CustomAdapterDisplayDebitorsList(Activity activity, Context context,List<Client> clients_list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.innerLayout.setBackgroundColor(Color.parseColor(colors.getColor("Crystal blue")));
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent (context, DisplayDebitorsListInner.class);
